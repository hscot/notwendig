...
def main():
    ...
    while True:
        try:
            ...
            font12 = ImageFont.truetype('fonts/arial.ttf', 8) #Note changed to 8 just for testing purposes!
            ...
            for i_d in range(0, 3):
                time_draw.text((0, (25 + (i_d*8))), (str(i_d + 1) + results_de[i_d]), font = font12, fill = 0)

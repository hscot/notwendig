...
def main():
    ...
    while True:
        try:
            ...
            font12 = ImageFont.truetype('fonts/arial.ttf', 10) #Note changed to 10 just for testing purposes!
            ...
            for i_d in range(0, 3):
                time_draw.text((0, (30 + (i_d*15))), (str(i_d + 1) + results_de[i_d]), font = font12, fill = 0)
